...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_MyPHPExt_Test_objectProperties, 0, 2, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO(0, object, IS_OBJECT, 0)
	ZEND_ARG_TYPE_INFO(0, standard, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_MyPHPExt_Test_hasObjectProperty, 0, 3, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, object, IS_OBJECT, 0)
	ZEND_ARG_TYPE_INFO(0, name, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, standard, _IS_BOOL, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_MyPHPExt_Test_setMixedReferenceProperty, 0, 4, IS_VOID, 0)
	ZEND_ARG_TYPE_INFO(0, target, IS_OBJECT, 0)
	ZEND_ARG_TYPE_INFO(0, name, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(1, value, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, api, IS_STRING, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_MyPHPExt_Test_castValue, 0, 3, IS_MIXED, 0)
	...
	ZEND_ARG_TYPE_INFO(0, convert, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_MyPHPExt_Test_castReferenceValue, 0, 3, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(1, value, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, type, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, convert, _IS_BOOL, 0)
ZEND_END_ARG_INFO()
...
ZEND_FUNCTION(MyPHPExt_Test_objectProperties);
...
#endif
#if (PHP_VERSION_ID >= 80400)
	ZEND_RAW_FENTRY(ZEND_NS_NAME("MyPHPExt\\Test", "objectProperties"), zif_MyPHPExt_Test_objectProperties, arginfo_MyPHPExt_Test_objectProperties, 0, NULL, NULL)
#else
	ZEND_RAW_FENTRY(ZEND_NS_NAME("MyPHPExt\\Test", "objectProperties"), zif_MyPHPExt_Test_objectProperties, arginfo_MyPHPExt_Test_objectProperties, 0)
#endif
#if (PHP_VERSION_ID >= 80400)
	ZEND_RAW_FENTRY(ZEND_NS_NAME("MyPHPExt\\Test", "hasObjectProperty"), zif_MyPHPExt_Test_hasObjectProperty, arginfo_MyPHPExt_Test_hasObjectProperty, 0, NULL, NULL)
#else
	ZEND_RAW_FENTRY(ZEND_NS_NAME("MyPHPExt\\Test", "hasObjectProperty"), zif_MyPHPExt_Test_hasObjectProperty, arginfo_MyPHPExt_Test_hasObjectProperty, 0)
#endif
#if (PHP_VERSION_ID >= 80400)
...
#else
	ZEND_RAW_FENTRY(ZEND_NS_NAME("MyPHPExt\\Test", "setMixedProperty"), zif_MyPHPExt_Test_setMixedProperty, arginfo_MyPHPExt_Test_setMixedProperty, 0)
#endif
#if (PHP_VERSION_ID >= 80400)
	ZEND_RAW_FENTRY(ZEND_NS_NAME("MyPHPExt\\Test", "setMixedReferenceProperty"), zif_MyPHPExt_Test_setMixedReferenceProperty, arginfo_MyPHPExt_Test_setMixedReferenceProperty, 0, NULL, NULL)
#else
	ZEND_RAW_FENTRY(ZEND_NS_NAME("MyPHPExt\\Test", "setMixedReferenceProperty"), zif_MyPHPExt_Test_setMixedReferenceProperty, arginfo_MyPHPExt_Test_setMixedReferenceProperty, 0)
#endif
#if (PHP_VERSION_ID >= 80400)
...
#else
	ZEND_RAW_FENTRY(ZEND_NS_NAME("MyPHPExt\\Test", "castValue"), zif_MyPHPExt_Test_castValue, arginfo_MyPHPExt_Test_castValue, 0)
#endif
#if (PHP_VERSION_ID >= 80400)
	ZEND_RAW_FENTRY(ZEND_NS_NAME("MyPHPExt\\Test", "castReferenceValue"), zif_MyPHPExt_Test_castReferenceValue, arginfo_MyPHPExt_Test_castReferenceValue, 0, NULL, NULL)
#else
	ZEND_RAW_FENTRY(ZEND_NS_NAME("MyPHPExt\\Test", "castReferenceValue"), zif_MyPHPExt_Test_castReferenceValue, arginfo_MyPHPExt_Test_castReferenceValue, 0)
#endif
#if (PHP_VERSION_ID >= 80400)
